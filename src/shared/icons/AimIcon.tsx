...
const AimIcon:React.FC<Props> = ({width, height, fill} :Props):JSX.Element => {

return(
    <React.Fragment>
        <svg xmlns="http://www.w3.org/2000/svg" width={width || "24"} height={height || "24"} fill={fill || "black"} viewBox="0 0 24 24">
